...
document.addEventListener("DOMContentLoaded", function () {
    ...
    addButton1.addEventListener("click", function () {
        ...
        // After a delay, start the animation for beaker5ml
        setTimeout(function () {
            // Apply CSS transitions for smooth animation
            beaker5ml.style.transition = "all 1s ease-in-out";

            // Move beaker5ml towards conicalflaskA
            beaker5ml.style.top = "55%";
            beaker5ml.style.right = "97%";
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    addButton4.addEventListener("click", function () {
        ...
        addButton7.addEventListener("click", function () {
            document.getElementsByClassName('flaska')[0].innerHTML = ` <img src="./BLUEBEAKER A.png" id="flaskA" alt="Image 1" style="    position: absolute;
            top: 66%;
            right: 91%;
            width: 7%;">`
            document.getElementsByClassName('clock')[0].style.display = "block"
            document.getElementsByClassName('ca')[0].style.display = "block"
