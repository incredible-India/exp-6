...
document.getElementsByClassName('flaskc')[0].innerHTML = ` <img src="./BLUE BEAKER C.png" id="flaskC" alt="Image 3" style=" position: absolute;               
top: 66%;
width: 7%;">`
...
document.getElementsByClassName('cc')[0].style.display = "block"
