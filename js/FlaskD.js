...
document.addEventListener("DOMContentLoaded", function () {
    ...
    addButton4.addEventListener("click", function () {
        ...
        addButton7.addEventListener("click", function () {
            ...
            document.getElementsByClassName('flaskb')[0].innerHTML = `  <img src="CONICAL_FLASK_B.png" id="flaskB" alt="Image 2">`
            document.getElementsByClassName('flaskc')[0].innerHTML = `   <img src="CONICAL_FLASK_C.png" id="flaskC"    alt="Image 3">`
document.getElementsByClassName('flaskd')[0].innerHTML = ` <img src="./BLUEBEAKERD.png" id="flaskC" alt="Image 3" style=" position: absolute;             
top: 66%;
right:75%;
width: 7%;">`
document.getElementsByClassName('clock')[0].style.display = "block"
document.getElementsByClassName('ca')[0].style.display = "none"
document.getElementsByClassName('cb')[0].style.display = "none"
document.getElementsByClassName('cc')[0].style.display = "none"
document.getElementsByClassName('cd')[0].style.display = "block"
